...
const { greet, farewell } = require("./greetings.js");
const { fetchData, postData } = require("./api.js");
const { formatDate, parseDate } = require("./date.js");
const { validateEmail, validatePhone } = require("./validators.js");
...
module.exports = { add, subtract, multiply, divide, greet, farewell };
